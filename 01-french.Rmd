...
```{r poi dev figure,eval=T,out.width="50%",fig.align = 'center'}
...
```{r tree cv figure,eval=T,out.width="60%",fig.align = 'center'}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
...
```{r rforest cv figure, eval=T,out.width="60%",fig.align = 'center'}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
