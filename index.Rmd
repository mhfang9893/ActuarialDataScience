...
据观察，在MAC OS和Linux系统下安装`keras`成功的比例较高。WIN系统下，Python各个包的依赖以及和R包的匹配有一定的问题，一般可以通过更换镜像源解决。也可以按[此环境](https://www.jianguoyun.com/p/DVX62MgQ3cTHBhiq2M0D)配置，使用命令`conda create --name <env> --file <this file>`。
